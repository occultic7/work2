...
<body>
<br>
<form action="GetStockInByDateOrUser.jsp" method="post">
入库人姓名:<input type="text" name="uname" value="" required="required"/>
...
System.out.print("GetStockInByDateOrUser.jsp测试：");
...
list1=StockInDao.getStockInByDateOrUser(uname, stime, etime);
