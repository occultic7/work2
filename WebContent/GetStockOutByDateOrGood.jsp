...
<body>
<br/>
<form action="GetStockOutByDateOrGood.jsp" method="post">
...
System.out.print("GetStockOutByDateOrGood.jsp测试：");
...
list1=StockOutDao.getStockOutByDateOrGood(Gname, stime, etime);
